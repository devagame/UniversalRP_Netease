            ...
            bool resolveFinalTarget)
        {
            if (additionalCameraData != null)
            {
                ...
                if (cameraData.renderType == CameraRenderType.Base)
                    cameraData.exData.baseCameraAmdFSR = additionalCameraData.renderPostProcessing
                        ? additionalCameraData.amdFSR
                        : UniversalAdditionalCameraData.AMDFSR.Disabled;

                if (resolveFinalTarget &&
                    cameraData.exData.baseCameraAmdFSR != UniversalAdditionalCameraData.AMDFSR.Disabled)
                {
