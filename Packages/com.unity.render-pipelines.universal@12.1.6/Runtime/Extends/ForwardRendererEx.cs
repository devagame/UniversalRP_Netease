...
namespace UnityEngine.Rendering.Universal
{
    partial class UniversalRenderer
    {
        ...
        public void InitCameraGammaRendering(UniversalRendererData data)
        {
            ...
            drawUIObjectPass = new DrawObjectsPassEx(nameof(drawUIObjectPass), false,
                RenderPassEvent.AfterRendering + 11, RenderQueueRange.transparent, LayerMask.GetMask("UI"),
                m_DefaultStencilState, data.defaultStencilState.stencilReference);
        ...
        public void SetupCameraGammaRendering(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (isUICamera)
            {
                ...
                drawUIObjectPass.RenderTarget = cameraData.exData.enableFSR
